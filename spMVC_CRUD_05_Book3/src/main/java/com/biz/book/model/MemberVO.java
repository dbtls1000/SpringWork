...
public class MemberVO {
	...
	private String m_userid; //primary key
	private String m_password;
	private String m_name;
	private String m_email;
	private String m_tel;
	private String m_role; // 회원이 어떤 등급을 갖는지
	...
	public String toString() {
		return "MemberVO [m_email=" + m_email + ", m_name=" + m_name + ", m_password=" + m_password + ", m_role="
				+ m_role + ", m_tel=" + m_tel + ", m_userid=" + m_userid + "]";
	}
